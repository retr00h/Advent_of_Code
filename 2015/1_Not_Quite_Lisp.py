...
# when you complete the first. Each puzzle grants you one star. Good luck!
#
...
with open(path.join(sys.path[0], "input\\1_Not_Quite_Lisp.txt")) as f:
  for line in f:
    line = line.strip()
    for c in line:
      inputList.append(c)
...
print("Part One: " + str(partOne(inputList))) # 74
...
print("Part Two: " + str(partTwo(inputList))) # 1795