...
#
#
# The expedition can depart as soon as the final supplies have
# been unloaded from the ships. Supplies are stored in stacks
# of marked crates, but because the needed supplies are buried
...
# stack.
# 
# The Elves don't want to interrupt the crane operator during
# this delicate procedure, but they forgot to ask her which
# crate will end up where, and they want to be ready to unload
# them as soon as possible so they can embark.
# 
# They do, however, have a drawing of the starting stacks of
# crates and the rearrangement procedure (your puzzle input).
# For example:
#
#     [D]
# [N] [C]
...
# 1 contains two crates: crate Z is on the bottom, and crate
# N is on top. Stack 2 contains three crates; from bottom to top,
# they are crates M, C, and D. Finally, stack 3 contains a single
# crate, P.
# 
...
# procedure, one crate is moved from stack 2 to stack 1, resulting
