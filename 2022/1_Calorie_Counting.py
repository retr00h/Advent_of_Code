...
# of magical energy (https://adventofcode.com/2018/day/25) to deliver presents
# on Christmas. For that, their favorite snack is a special type of star fruit
...
with open(path.join(sys.path[0], "input\\1_Calorie_Counting.txt")) as f:
  calories = 0
  for line in f:
    if line == '\n':
...
def part_one(calories_per_elf): return max(calories_per_elf)

print("Part One: " + str(part_one(calories_per_elf))) # 66487
...
print("Part Two: " + str(part_two(calories_per_elf))) # 197301